        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Update partner logo information. Drag & drop or click to browse.</p>
                    </div>
                </div>
            </div>
            <div class="admin-card-body">
                <form method="POST" action="{{ route('admin.partner_logos.update', [$partnerLogo]) }}" enctype="multipart/form-data">
                    ...
                    {{-- Image --}}
                    <div class="admin-form-group mb-5">
                        <label class="admin-form-label">{{ __('Logo Image') }}</label>
                        ...
                        {{-- Dropzone --}}
                        <div id="dropzoneWrapper" class="{{ $partnerLogo->image ? 'hidden' : '' }}">
                            ...
                            <div id="previewArea" class="hidden mt-4">
                                <div class="relative group bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm">
                                    <div class="overflow-hidden flex items-center justify-center p-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Delete existing image button - shows dropzone after delete
    if (deleteImageBtn) {
        deleteImageBtn.addEventListener('click', function() {
            // Hide existing image wrapper and show dropzone
