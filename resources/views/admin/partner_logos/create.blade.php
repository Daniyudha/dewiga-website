...
@section('content')
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-heading font-bold text-gray-900">{{ __('Add Partner Logo') }}</h1>
        <p class="text-sm text-gray-500 mt-1">Upload a new client/partner logo</p>
    </div>
    ...
    <div class="admin-card max-w-2xl">
        <div class="admin-card-body">
            <form method="POST" action="{{ route('admin.partner_logos.store') }}" enctype="multipart/form-data">
                ...
                {{-- Image --}}
                <div class="admin-form-group mb-5">
                    <label for="image" class="admin-form-label">{{ __('Logo Image') }} <span class="text-red-500">*</span></label>
                    <input type="file" id="image" name="image" accept="image/*"
                           class="admin-form-input @error('image') error @enderror p-2" required>
