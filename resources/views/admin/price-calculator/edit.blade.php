                        ...
                        <div id="addonItemsContainer" class="space-y-3">
                            ...
                            <div class="addon-item-row bg-gray-50 rounded-lg p-4 border border-gray-200 space-y-3">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div><label class="admin-label text-xs">Nama Add-on</label><input type="text" class="admin-input ao-name" value="{{ $addon['name'] }}"></div>
                                    <div><label class="admin-label text-xs">Harga Satuan (Rp)</label><input type="number" class="admin-input ao-price" min="0" value="{{ $addon['unit_price'] }}" step="1000"></div>
