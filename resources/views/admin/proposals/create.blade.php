...
<div class="border-b border-gray-200 mb-6">
    <nav class="-mb-px flex space-x-6">
        <button onclick="switchMethod('dari_estimasi')" class="tab-method active px-4 py-3 text-sm font-medium border-b-2 border-primary-500 text-primary-600" data-method="dari_estimasi" type="button">
                    ...
                    <div class="admin-card-body space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="proposal_title" value="{{ old('proposal_title') }}" class="form-input" placeholder="Program Kunjungan Edukasi...">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea name="program_objective" rows="2" class="form-input" placeholder="Tujuan dari program kunjungan ini...">{{ old('program_objective') }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="admin-card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="institution_name" value="{{ old('institution_name') }}" class="form-input" required>
                            </div>
                            <div>
                                <label class="form-label">Penanggung Jawab <span class="text-red-500">*</span></label>
                                <input type="text" name="contact_person" value="{{ old('contact_person') }}" class="form-input" required>
                            </div>
                            <div>
                                <label class="form-label">No. WhatsApp <span class="text-red-500">*</span></label>
                                <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" class="form-input" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="date" name="arrival_date" value="{{ old('arrival_date') }}" class="form-input" required>
                            </div>
                            <div>
                                <label class="form-label">Tanggal Kepulangan <span class="text-red-500">*</span></label>
                                <input type="date" name="departure_date" value="{{ old('departure_date') }}" class="form-input" required>
                            </div>
                            <div>
                                <label class="form-label">Jumlah Siswa <span class="text-red-500">*</span></label>
                                <input type="number" name="student_count" value="{{ old('student_count', 0) }}" class="form-input" min="0" required>
                            </div>
                            <div>
                                <label class="form-label">Jumlah Pendamping</label>
                                <input type="number" name="companion_count" value="{{ old('companion_count', 0) }}" class="form-input" min="0">
                            </div>
                        </div>
                        <div class="mt-4">
                            <label class="form-label">Catatan / Kebutuhan Khusus</label>
                    ...
                    <div class="admin-card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="live_in_nights" value="{{ old('live_in_nights', 0) }}" class="form-input" min="0">
                            </div>
                            <div>
                                <label class="form-label">Makan (kali)</label>
                                <input type="number" name="meal_count" value="{{ old('meal_count', 0) }}" class="form-input" min="0">
                            </div>
                            <div>
                                <label class="form-label">Snack (kali)</label>
                                <input type="number" name="snack_count" value="{{ old('snack_count', 0) }}" class="form-input" min="0">
                            </div>
                            <div>
                                <label class="form-label">Kegiatan Reguler</label>
                                <input type="number" name="regular_activity_count" value="{{ old('regular_activity_count', 0) }}" class="form-input" min="0">
                            </div>
                            <div>
                                <label class="form-label">Sesi Kesenian</label>
                                <input type="number" name="art_sessions" value="{{ old('art_sessions', 0) }}" class="form-input" min="0">
                            </div>
                            <div>
                                <label class="form-label">Pertunjukan Kesenian</label>
                                <input type="number" name="cultural_performances" value="{{ old('cultural_performances', 0) }}" class="form-input" min="0">
                            </div>
                        </div>
                        <div class="mt-3">
...
function switchMethod(method) {
    ...
    document.querySelector(`.tab-method[data-method="${method}"]`).classList.add('active', 'border-primary-500', 'text-primary-600');
    document.querySelector(`.tab-method[data-method="${method}"]`).classList.remove('border-transparent', 'text-gray-500');
}
</script>
@endpush