...
@section('content')
    ...
    <section class="relative bg-neutral-900 overflow-hidden min-h-[100vh] flex items-center pt-24 pb-16">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center text-white mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto text-left">
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 p-5 rounded-2xl flex items-start gap-3">
                    <div class="p-2 bg-[#00a877]/20 rounded-lg text-[#00c887]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                    </div>
                    <div>
                        <h4 class="font-semibold text-sm text-white">{{ __('messages.hero_highlights.location') }}</h4>
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 p-5 rounded-2xl flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-sm text-white">{{ __('messages.hero_highlights.salak') }}</h4>
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 p-5 rounded-2xl flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-sm text-white">{{ __('messages.hero_highlights.homestay') }}</h4>
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/10 p-5 rounded-2xl flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-sm text-white">{{ __('messages.hero_highlights.guide') }}</h4>
    ...
    {{-- SECTION 3: PAKET WISATA (POPULAR PACKAGES SWIPER) --}}
    @include('partials.home-popular')

    {{-- SECTION 4: RAGAM KEGIATAN SERU (FEATURED ACTIVITIES) --}}
    @include('partials.home-featured')

    {{-- SECTION 5: TESTIMONIALS (SWIPER SLIDER) --}}
    ...
    {{-- SECTION 8: AI CALL TO ACTION (CTA) --}}
    ...
    {{-- SECTION 9: FAQ (PERTANYAAN YANG SERING DIAJUKAN) --}}
