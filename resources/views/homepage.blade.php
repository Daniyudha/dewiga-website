...
@section('content')
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="bg-white rounded-2xl p-6 shadow-lg flex flex-col h-full border border-slate-50">
                                ...
                                <div class="flex-1">
                                    ...
                                    @lang('messages.testimonials.read_more') <i class="bx bx-chevron-right align-middle"></i>
                                </button>
                                </div>
    ...
    <div id="testimonialModal" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 opacity-0 invisible transition-all duration-300"
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[85vh] overflow-y-auto p-6 md:p-8 transform scale-95 transition-all duration-300"
            ...
            <div class="flex items-start justify-between mb-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="font-heading text-lg font-bold text-primary-900" id="testimonialModalName"></h3>
                        <div class="flex gap-0.5 text-yellow-500 text-xs mt-1">
                            <i class="bx bxs-star"></i><i class="bx bxs-star"></i><i class="bx bxs-star"></i><i class="bx bxs-star"></i><i class="bx bxs-star"></i>
                        </div>
                    </div>
                </div>
                <button type="button" onclick="closeTestimonialModal()" class="text-gray-400 hover:text-red-500 transition-colors text-3xl">
                    <i class="bx bx-x"></i>
                </button>
            </div>
            <div class="text-primary-600 leading-relaxed text-base italic" id="testimonialModalContent">
            </div>
        </div>
    </div>
...
<script>
    // 1. Fungsi Modal
    function openTestimonialModal(name, content) {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (btn) {
            ...
            openTestimonialModal(name, content);
        }
    });
