...
class RoleUserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $superAdmin = Role::firstOrCreate(
            ['slug' => 'super_admin'],
            ['name' => 'Super Admin', 'description' => 'Akses penuh ke semua fitur', 'is_default' => false]
        );

        $admin = Role::firstOrCreate(
            ['slug' => 'admin'],
            ['name' => 'Admin', 'description' => 'Akses ke fitur operasional dan konten', 'is_default' => false]
        );

        $finance = Role::firstOrCreate(
            ['slug' => 'finance'],
            ['name' => 'Finance', 'description' => 'Akses ke fitur transaksi dan keuangan', 'is_default' => false]
        );

        $contentManager = Role::firstOrCreate(
            ['slug' => 'content_manager'],
            ['name' => 'Content Manager', 'description' => 'Mengelola konten website', 'is_default' => false]
        );
        ...
        $admin->syncPermissions([
            'dashboard.view', 'bookings.view', 'bookings.create', 'bookings.edit', 'bookings.confirm',
        ...
        $contentManager->syncPermissions([
            'dashboard.view', 'blogs.manage', 'galleries.manage', 'testimonials.manage',
            'hero.manage', 'partners.manage', 'categories.manage',
            'packages.view', 'packages.create', 'packages.edit',
        ]);

        // Create or update admin user and assign Super Admin
